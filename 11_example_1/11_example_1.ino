...
// EMA weight of new sample (range: 0 to 1)
...
Servo myservo; // Servo 모터 클래스의 객체변수 선언
...
void loop() {
  ...
  if(dist_ema < _DIST_MIN){
    ...
    myservo.writeMicroseconds(num(dist_ema));
  }
  else{
...
int num(int dist_ema){
  return ((dist_ema - 180)*(2400/180))+30;
}
